...
- [ ] **Auto-update mechanism** — Tauri updater plugin, check on launch, notify + one-click install
- [ ] **Error toast system** — surface parse errors, file write failures, and watcher issues as dismissible toasts (not console.log)
